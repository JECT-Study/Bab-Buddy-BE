...
import babbuddy.domain.oauth2.infra.filter.BabbuddyJWTFilter;
import babbuddy.domain.oauth2.infra.filter.BabbuddyLogoutFilter;
import babbuddy.global.infra.exception.auth.BabbuddyAuthExceptionFilter;
...
public class SecurityConfig {
    ...
    private final List<String> excludedUrls = Arrays.asList("/api/food/image","/v3/api-docs/**", "/swagger-ui/**","/api/users/restaurants", "/swagger-ui.html","/favicon.ico","/api/reissue", "/api/oauth2/login", "/api/healthcheck", "/api/oauth2/callback");
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .cors((cors) -> cors.configurationSource(request -> {
                    ...
                    config.setAllowedOriginPatterns(List.of("https://babbuddy-15-fe.vercel.app", "http://localhost:3000"));
                ...
                .authorizeHttpRequests((url) -> url
                        ...
                        .requestMatchers("/api/reissue","/api/users/restaurants","/api/food/image").permitAll()
